...
namespace OnChainStudios.FileTemplates
{
    ...
    public static  partial class VisualScriptingTemplateFactory
    {
        ...
        public static void CreateApplicationGet() => CreateVisualScriptingAsset(TemplateAssetPaths.Variables.Application.Get, SubFolderPaths.Variables.Application.Get, TypeIdentifiers.Variables.Application.Get, FileNameSuffixes.NewFileSuffix, true);

        /// <summary>
        /// Creates a Application Has Variable script graph.
        /// </summary>
        [MenuItem(MenuItemPaths.Variables.Application.Has)]
        public static void CreateApplicationHas() => CreateVisualScriptingAsset(TemplateAssetPaths.Variables.Application.Has, SubFolderPaths.Variables.Application.Has, TypeIdentifiers.Variables.Application.Has, FileNameSuffixes.NewFileSuffix, true);
